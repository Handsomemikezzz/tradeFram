...
const NAV_ITEMS = [
  ...
  { icon: Filter, label: '选股', path: '/screeners' },
    ...
    <aside className="w-56 bg-[var(--color-sidebar-dark)] text-white flex flex-col h-screen sticky top-0 shrink-0">
      <div className="p-6 border-b border-white/10">
        <div className="flex items-center space-x-2">
          <div className="w-6 h-6 bg-blue-500 rounded-sm flex items-center justify-center font-bold text-[10px] text-white leading-none">定</div>
          <div className="min-w-0">
            <h1 className="text-sm font-bold tracking-tight leading-tight">{BRAND.sidebarTitle}</h1>
            <p className="text-[10px] text-gray-400 leading-tight">{BRAND.sidebarSubtitle}</p>
          </div>
        </div>
      </div>
